...
public class PrPayrollSettingsResource {
    ...
    private void generatePayrollSetings(PrPayrollSettingsDTO prPayrollSettingsDTO){
        ...
        // if calculation number is not manually entered, generate it
        if(prPayrollSettingsDTO.getCalculationNumber() == null || prPayrollSettingsDTO.getCalculationNumber().trim().equals("")) {
